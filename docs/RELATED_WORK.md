...
This note situates **Where Linear Features Break in Small Transformers** against the mentor-linked literature for
[Where Linear Features Break in Small Transformers](https://github.com/alanasung/representation-linearity).

## Positioning

Measure when residual features stay linear under intervention and when they don't.

The design hypothesis is: Measure when residual features stay linear under intervention and when they don't.
