import json
from linrep.reporting.aggregate import aggregate_results, flatten_metrics
from linrep.reporting.tables import write_tables
from linrep.reporting.figures import write_caption, write_figures
