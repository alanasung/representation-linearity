"""Experiment stages for Where Linear Features Break in Small Transformers."""
...
from .linrep._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "Where Linear Features Break in Small Transformers", "claims_gated": True})
