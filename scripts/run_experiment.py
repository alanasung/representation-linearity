...
from linrep.configs.loader import register_schema
...
def _load_stage_registry(package: str = "linrep") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in linrep.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from linrep.configs.loader import config_to_dict, save_resolved_config
    from linrep.models.device import get_device
    from linrep.utils.logging import configure_logging
    from linrep.utils.reproducibility import set_seed
    from linrep.utils.run_manifest import create_run_dir, save_run_metadata
